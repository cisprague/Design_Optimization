classdef UAV
  ...
  methods
    ...
    function F = Sectional_Force(obj, R)
      ...
      F = g*(obj.Mass/obj.Length)*...
            (1-(obj.Span_Mesh(R)./obj.Length));
    end
    function Plot_Sectional_Force(obj, R)
      % Plots the spanwise load distribution.
      figure;
      plot(obj.Span_Mesh(R),...
           obj.Sectional_Force(R),'ks-')
    ...
    function SS = Spar_Stress(obj, R)
      ...
      SS = CalcBeamStress(...
        obj.Length, obj.E, obj.Max_Height(R), ...
